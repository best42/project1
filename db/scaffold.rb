rails g scaffold note title:string description:text subject:string teacher:text rating:integer owner:text create_note:date image_note:text
...
rails g paperclip PoiNoteInfo image
